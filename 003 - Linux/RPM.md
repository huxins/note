...
[RPM](https://rpm.org/) 是基于 Red Hat Enterprise Linux 的发行版中流行的[包管理工具](https://www.redhat.com/sysadmin/how-manage-packages)。使用 RPM，您可以安装、卸载和查询单个软件包。不过，它不能像 YUM 那样管理依赖项解析。RPM 包由文件和元数据的存档组成。元数据包括帮助程序脚本、文件属性和有关包的信息。
