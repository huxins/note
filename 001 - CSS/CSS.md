...
在 CSS 中，每个更高级别的功能集（如 CSS Level 2, CSS Level 3 等）包含了所有较低级别的功能，并在此基础上添加了新功能。因此，更高的级别是较低级别的超集。
...
总结来说，在 CSS 中，每个更高 *level* 的功能集是任何较低级别的超集，因为每个更高 *level* 包含了较低级别的所有功能，并在此基础上添加了更多的新特性。
